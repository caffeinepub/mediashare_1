...
import { User, Upload, Image, LogIn, UserPlus, Edit2, DollarSign } from 'lucide-react';
...
export default function Profile() {
  ...
  const myPhotos = photos?.filter(
    (p) => p.uploader.toString() === principalStr
  ) ?? [];
        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent className="space-y-3">
            <p className="text-center text-muted-foreground text-sm mb-4">
              Sign in to view your profile, manage your content, and track your earnings.
            </p>
            ...
            {profileLoading ? (
              ...
              <>
                ...
                {userProfile?.channelName && (
                  <p className="text-muted-foreground">@{userProfile.channelName}</p>
                )}
              </>
            )}
          </div>
        ...
        <Tabs defaultValue="videos">
          ...
          <TabsContent value="videos">
            <div className="flex justify-between items-center mb-4">
              ...
              <Button size="sm" onClick={() => navigate({ to: '/upload-video' })}>
          ...
          <TabsContent value="photos">
            <div className="flex justify-between items-center mb-4">
              ...
              <Button size="sm" onClick={() => navigate({ to: '/upload-photo' })}>
