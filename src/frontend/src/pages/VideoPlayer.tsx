...
import { Clock, Edit2, Eye, Loader2, Tag, ThumbsUp } from "lucide-react";
...
export default function VideoPlayer() {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: intentionally reset refs on id change
  useEffect(() => {
  ...
  const handleTimeUpdate = useCallback(() => {
    ...
    if (
      !adImpressionRecordedRef.current &&
      watchedSecondsRef.current >= AD_IMPRESSION_THRESHOLD_SECONDS
    ) {
