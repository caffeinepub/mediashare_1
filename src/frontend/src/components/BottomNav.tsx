...
import { Home, PlaySquare, Upload, Users } from "lucide-react";
...
export function BottomNav() {
  ...
  return (
    ...
    >
      <div
        className="flex items-stretch justify-around h-16 sm:h-20"
        style={{ overflow: "visible" }}
      >
        ...
        >
          ...
          />
          <span
            className={`text-xs font-medium leading-none ${isProfileActive ? "font-semibold" : ""}`}
          >
            Profile
          </span>
        </div>
