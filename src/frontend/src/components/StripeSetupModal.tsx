    ...
    <Dialog open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Enter your Stripe secret key to enable premium subscriptions. You
            can find this in your{" "}
            <a
        ...
        <div className="space-y-4 py-2">
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Use <code>sk_test_...</code> for testing, <code>sk_live_...</code>{" "}
              for production.
            </p>
          </div>
        ...
        <DialogFooter>
          ...
          <Button
            onClick={handleSave}
            disabled={setConfigMutation.isPending || !secretKey.trim()}
          >
